      ...
      <header className="bg-blue-600 shadow-xl">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <Link to="/" className="flex items-center space-x-2 text-white hover:text-cyan-200 transition-colors">
              <ArrowLeft size={24} />
          ...
          <Card className="bg-white border-0 shadow-xl hover:shadow-2xl transition-all duration-300">
            <CardContent className="p-8">
              ...
              <p className="text-blue-600 leading-relaxed opacity-80">
                ...
                tegen een eerlijke prijs. Jouw comfort en tevredenheid staan centraal in alles wat wij doen in Rotterdam en omgeving.
              </p>
            </CardContent>
          </Card>
